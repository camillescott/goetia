...
cdef extern from "cdbg.hh":
    cdef uint64_t NULL_ID

cdef extern from "cdbg.hh" namespace "boink" nogil:
    ...
    cdef cppclass CpCompactEdge "boink::CompactEdge":
    ...
    cdef cppclass CpCompactEdgeFactory "boink::CompactEdgeFactory" (CpKmerFactory):
    ...
    cdef cppclass CpCompactNode "boink::CompactNode":
        CpKmer kmer
        uint32_t count
        const id_t node_id
        string sequence
    ...
    cdef cppclass CpCompactNodeFactory "boink::CompactNodeFactory" (CpKmerFactory):
    ...
    cdef cppclass CpStreamingCompactor "boink::StreamingCompactor":
