...
cdef class cDBG__BitStorage__DefaultShifter(cDBG_Base):
    ...
    @staticmethod
    cdef cDBG__BitStorage__DefaultShifter _wrap(shared_ptr[_cDBG[_dBG[_BitStorage,_DefaultShifter]]] ptr):
...
cdef class cDBG__ByteStorage__DefaultShifter(cDBG_Base):
    ...
    @staticmethod
    cdef cDBG__ByteStorage__DefaultShifter _wrap(shared_ptr[_cDBG[_dBG[_ByteStorage,_DefaultShifter]]] ptr):
        cdef cDBG__ByteStorage__DefaultShifter cdbg = cDBG__ByteStorage__DefaultShifter()
        cdbg._this = ptr
        cdbg.Notifier = EventNotifier._wrap(<shared_ptr[_EventNotifier]>cdbg._this)
        cdbg.storage_type = "_ByteStorage"
        cdbg.shifter_type = "_DefaultShifter"
        return cdbg
...
cdef class cDBG__NibbleStorage__DefaultShifter(cDBG_Base):
    ...
    @staticmethod
    cdef cDBG__NibbleStorage__DefaultShifter _wrap(shared_ptr[_cDBG[_dBG[_NibbleStorage,_DefaultShifter]]] ptr):
        cdef cDBG__NibbleStorage__DefaultShifter cdbg = cDBG__NibbleStorage__DefaultShifter()
        cdbg._this = ptr
        cdbg.Notifier = EventNotifier._wrap(<shared_ptr[_EventNotifier]>cdbg._this)
        cdbg.storage_type = "_NibbleStorage"
        cdbg.shifter_type = "_DefaultShifter"
        return cdbg
...
cdef class cDBG__SparseppSetStorage__DefaultShifter(cDBG_Base):
    ...
    @staticmethod
    cdef cDBG__SparseppSetStorage__DefaultShifter _wrap(shared_ptr[_cDBG[_dBG[_SparseppSetStorage,_DefaultShifter]]] ptr):
        cdef cDBG__SparseppSetStorage__DefaultShifter cdbg = cDBG__SparseppSetStorage__DefaultShifter()
        cdbg._this = ptr
        cdbg.Notifier = EventNotifier._wrap(<shared_ptr[_EventNotifier]>cdbg._this)
        cdbg.storage_type = "_SparseppSetStorage"
        cdbg.shifter_type = "_DefaultShifter"
        return cdbg
