...
cdef class dBG_BitStorage_DefaultShifter(dBG_Base):
    cdef unique_ptr[_dBG[BitStorage,DefaultShifter]] _this
    cdef unique_ptr[_AssemblerMixin[_dBG[BitStorage,DefaultShifter]]] _assembler
    cdef hash_t _handle_kmer(self, object) except 0
cdef class dBG_NibbleStorage_DefaultShifter(dBG_Base):
    cdef unique_ptr[_dBG[NibbleStorage,DefaultShifter]] _this
    cdef unique_ptr[_AssemblerMixin[_dBG[NibbleStorage,DefaultShifter]]] _assembler
    cdef hash_t _handle_kmer(self, object) except 0
cdef class dBG_ByteStorage_DefaultShifter(dBG_Base):
    cdef unique_ptr[_dBG[ByteStorage,DefaultShifter]] _this
    cdef unique_ptr[_AssemblerMixin[_dBG[ByteStorage,DefaultShifter]]] _assembler
    cdef hash_t _handle_kmer(self, object) except 0
