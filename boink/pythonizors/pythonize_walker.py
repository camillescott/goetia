...
def pythonize_boink(klass, name):
    ...
    if is_walker:
        ...
        klass.Walk[gbl.boink.hashing.DIR_LEFT].__str__ = klass.Walk[gbl.boink.hashing.DIR_LEFT].to_string
        klass.Walk[gbl.boink.hashing.DIR_RIGHT].__str__ = klass.Walk[gbl.boink.hashing.DIR_RIGHT].to_string
