...
def get_cdbg_args(parser):
    ...
    group.add_argument('--track-cdbg-history',
                        ...
                        nargs='?',
                        const='goetia.cdbg.history.graphml')
...
class cDBGRunner(CommandRunner):
    ...
    def setup(self, args):
        print('goetia cdbg: start setup.', file=sys.stderr)
        ...
        if args.normalize:
            self.processor = self.compactor_t.NormalizingCompactor[libgoetia.parsing.FastxReader].build(self.compactor,
                                                                                                       args.normalize,
                                                                                                       args.fine_interval,
        ...
        print('goetia cdbg: finish setup.', file=sys.stderr)
                           
    def execute(self, args):
        print('goetia cdbg: start execution.', file=sys.stderr)
