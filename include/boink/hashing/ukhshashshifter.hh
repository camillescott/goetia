...
#ifndef BOINK_UKHSHASHSHIFTER_HH
#define BOINK_UKHSHASHSHIFTER_HH
...
class UnikmerShifter : public HashShifter<UnikmerShifter<ShifterType>,
                       ...
                       public Tagged<UnikmerShifter<ShifterType>> {
...
public:
    ...
    auto _left_extensions(const std::string& symbols)
    ...
    auto _right_extensions(const std::string& symbols)
